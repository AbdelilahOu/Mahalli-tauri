...
CREATE TABLE IF NOT EXISTS "orders" ( "id" text NOT NULL PRIMARY KEY, "supplier_id" text NOT NULL, "created_at" text NOT NULL DEFAULT CURRENT_TIMESTAMP, "status" text NOT NULL, FOREIGN KEY ("supplier_id") REFERENCES "suppliers" ("id") ON DELETE CASCADE );
